...
#dereplication
vsearch -fastx_uniques all_SF.fasta -fastaout all_SF_DR.fasta -sizeout
...
#remove chimeras
vsearch --uchime3_denovo clustered.fasta --sizein --sizeout --nonchimeras c_unchimered.fasta -threads $threads
vsearch --uchime_ref c_unchimered.fasta --sizein --sizeout --nonchimeras uparse_otus.fasta --db $chimera -threads $threads
#OTU table creation
vsearch -usearch_global ../all_labelled.fasta -db uparse_otus.fasta -strand both -id 0.97 -otutabout uparse_otu_tab.txt -biomout uparse_otu_biom.biom -threads $threads
...
#ASV table creation
vsearch -usearch_global ../all_labelled.fasta -db unoise_zotus.fasta -strand both -id 0.97 -otutabout unoise_zotus_tab.txt -biomout unoise_zotus_biom.biom  -threads $threads
